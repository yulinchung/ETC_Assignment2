...
I used ChatGPT (https://chatgpt.com/) help to check my writing grammar, improve sentence flow and identify possible errors in my assignment guide, across multiple iterations. However, I modified the outputs by selecting relevant suggestions, rewriting the wording to match my own explanation style, and checking that the Git commands and descriptions matched the steps I completed myself.
